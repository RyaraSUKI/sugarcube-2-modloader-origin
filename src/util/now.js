...
/*
	...
	NOTE: If the `Performance` API is available, then the epoch will be approximately
	the document creation time.  Elsewise, it will be the ECMAScript epoch (1 January
	1970 UTC).
*/
