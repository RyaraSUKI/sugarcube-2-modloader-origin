...
var version = (() => { // eslint-disable-line no-unused-vars, no-var
    ...
    return Object.preventExtensions(Object.create(null, {
        ...
        major: {
            value: '{{BUILD_VERSION_MAJOR}}'
        },
        minor: {
            value: '{{BUILD_VERSION_MINOR}}'
        },
        patch: {
            value: '{{BUILD_VERSION_PATCH}}'
        },
        prerelease: {
            value: '{{BUILD_VERSION_PRERELEASE}}'
        },
        build: {
            value: '{{BUILD_VERSION_BUILD}}'
        },
        date: {
            value: new Date('{{BUILD_VERSION_DATE}}')
        },
